...
class visual_localization:
  def __init__(self):
    ...
    self.location_pub=rospy.Publisher("pick_location",pa_location,queue_size=5)
  ...
  def callback(self,data):
    ...
    try:
      ...
      if(len(cntrs)==3):
        ...
        self.pick_location.x=(cx-11.0)/0.945/1000.0
        self.pick_location.y=(cy-5.0)/0.945/1000.0
